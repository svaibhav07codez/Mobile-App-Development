...
iv_animate.startAnimation(AnimationUtils.loadAnimation(getApplicationContex
t(),R.anim.zoom_in));
}
});
...
@Override
public void onClick(View v) {
iv_animate.animate().translationYBy(-
300f).setDuration(600);
}
});
...
@Override
public void onClick(View v) {
iv_animate.animate().translationXBy(-
300f).setDuration(600);
}
});
}
